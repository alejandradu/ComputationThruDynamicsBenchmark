...
RUN_DESC = "ngru_250_N"  # Description of the run
...
SEARCH_SPACE = {
    "datamodule.prefix": "20250413_PClicks_NoisyGRU_final2", # prefix for TT sweep
    "model.latent_size": tune.grid_search([32,64,128,256,512]), 
    "trainer.max_epochs": tune.grid_search([500, 501]), 
    "params.seed": 0,
    "model.lr": 1e-4,   # prob too high
    "model.weight_decay": 1e-4,
    "model.encoder_size": 128,
    "datamodule.file_index": 5,         # CHANGE ME
    "model.output_nonlinearity": tune.grid_search(["torch.nn.functional.softplus", None]), 
