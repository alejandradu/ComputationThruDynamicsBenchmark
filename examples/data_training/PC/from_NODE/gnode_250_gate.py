...
RUN_DESC = "gnode_250_gating"  # Description of the run
MODEL_CLASS = "SAE"  # "LFADS" or "SAE" MAYBE ALSO HAS LDS
MODEL = "gNODE"  # see /ctd/data_modeling/configs/models/{MODEL_CLASS}/ for options
...
SEARCH_SPACE = {
    ...
    "model.latent_size": 2, 
    "trainer.max_epochs": tune.grid_search([700, 701, 702, 703, 704]), 
    "params.seed": 0,
    ...
    "model.gating_scale": tune.grid_search( [1.0, 5,0, 10.0, 15.0, 25.0, 50.0, 75.0, 100.0]),
